...
INCLUDEPATH += "F:\extpkg\VTK\include\vtk-8.2"
INCLUDEPATH += "F:\MyWorkSpace2\QTTrial\MyStudio\include"
INCLUDEPATH += "D:\eigen\eigen"

LIBS+= -L$$quote("F:\extpkg\VTK\lib")
...
#    -l$(Qt_LIBS_) \
#    -l$(NOINHERIT)
# INCLUDEPATH += $$PWD/include/eigen-3.1.3/eigen-3.1.3


win32:CONFIG(release, debug|release): {
    LIBS +=-L$$quote("F:/MyWorkSpace2/QTTrial/MyStudio/lib/release") -lAPILib
#    QMAKE_CFLAGS_RELEASE += /MT
#    QMAKE_CXXFLAGS_RELEASE += /MT
}
else:win32:CONFIG(debug, debug|release): {
    LIBS += -L$$quote("F:/MyWorkSpace2/QTTrial/MyStudio/lib/debug") -lAPILib
#    QMAKE_CFLAGS_DEBUG += /MTd
#    QMAKE_CXXFLAGS_DEBUG += /MTd
}

HEADERS += ./MessageDockWidget.h \
    ./TableDockWidget.h \
    ./QtVTKPlatform.h \
    ./PlotWidget.h \
    ./FileReader.h \
    ./CusInteractorStyle.h
SOURCES += ./FileReader.cpp \
    ./TableDockWidget.cpp \
    ./MessageDockWidget.cpp \
    ./PlotWidget.cpp \
    ./QtVTKPlatform.cpp \
    ./CusInteractorStyle.cpp \
    ./main.cpp
FORMS += ./QtVTKPlatform.ui
RESOURCES += ViewToolBar.qrc
